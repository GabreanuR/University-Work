...
/***** intro clase abstracte, atribuire de pointeri etc *****/
/*
class Baza
{
public:
...
/*
    ...
    int*p = &a;
    float*q;
///    q = p; /// nu merge atribuire directa -> conversie
    q = (float*)p;
    cout<<*q;
}
*/
...
class universitate : public Baza
{
public:
    void afis(){cout<<"universitatea ";}
};

class oras: public Baza
{
public:
...
///    ob.afis(); /// ambiguitate - necesita rescrierea functiei, sau apel explicit ob.universitate::afis();
    ob.universitate::afis();
    ob.oras::afis();
///    ob.Baza::afis(); /// ambiguitate daca diamant nerezolvat
}
*/
